  ...
  data: {
    content: [
      ...
      },
      {
        resumeId: 2,
        title:
          '카카오 프론트엔드 지원용 이력서 (React, Next.js 중심의 포트폴리오 포함)',
        updatedAt: '2024-05-02 09:12:03',
        completedSections: [
          'educations',
          'techStacks',
          'projects',
      ...
      {
        resumeId: 3,
        title: '삼성 소프트웨어 엔지니어 채용용 이력서',
        updatedAt: '2024-06-20 14:45:10',
        completedSections: [
          'educations',
          'careers',
          'projects',
      ...
      {
        resumeId: 4,
        title: '토스 데이터 엔지니어 포지션 지원 이력서',
        updatedAt: '2024-07-11 11:05:00',
        completedSections: [
          'educations',
          'techStacks',
          'trainings',
      ...
      {
        resumeId: 5,
        title: '우아한형제들 모바일 개발자 지원용 이력서',
        updatedAt: '2024-08-01 16:20:33',
        completedSections: ['educations', 'careers', 'techStacks'],
      },
      {
        resumeId: 6,
        title: '스타트업 풀스택 개발자(프로젝트 중심) 이력서',
        updatedAt: '2024-09-10 08:00:00',
        completedSections: [
          'projects',
          'techStacks',
          'customLinks',
